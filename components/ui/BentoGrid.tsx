...
export const BentoGridItem = ({
  ...
  return (
    ...
    >
      ...
      <div className="font-merienda text-amber-50 text-xs md:text-sm lg:text-xl text-[#e5e5eb] z-10 py-0 group-hover/bento:text-black transition-colors mt-5 duration-400 text-justify">
  {description}
</div>
