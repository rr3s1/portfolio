...
export const BentoGridItem = ({
  ...
  return (
    ...
    >
      ...
      <div className="font-merienda font-normal text-xs md:text-sm lg:text-2xl text-[#e5e5eb] z-10 py-0 group-hover/bento:text-black transition-colors mt-5 duration-400 text-justify">
  {description}
</div>
