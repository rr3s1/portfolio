      ...
      <div className={`${id === 6 && 'flex justify-center items-center'} h-full relative z-10`}>
        ...
        >
          ...
          {description && (
            <div 
              className={cn(
                "font-sans text-xs md:text-sm lg:text-base text-neutral-300 z-20 py-0 mt-5", // py-0 and mt-5 were part of original styling
          ...
          {id === 6 && (
            <div className="mt-5 z-20 relative"> {/* Spacing for the button */}
              <HoverButton
                onClick={handleCopy}
                className="h-16 w-full md:w-80 md:mt-10 rounded-xl !bg-[#161a31] text-lg font-medium"
              >
                <span className="flex items-center justify-center gap-3 h-full"> 
                  <IoCopyOutline />
