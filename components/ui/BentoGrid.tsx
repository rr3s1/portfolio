...
>
  ...
  return (
    ...
    >
      ...
      <div className="font-merienda text-xs md:text-sm lg:text-xl text-[#e5e5eb] text-shadow:0_3px_5px_rgba(255, 0, 0, 0.8) z-10 py-0 group-hover/bento:text-black transition-colors mt-5 duration-400 ">
  {description}
</div>
