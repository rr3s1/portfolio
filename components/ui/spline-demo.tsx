  ...
  return (
    <Card className="w-full h-[750px] relative overflow-hidden border-0 bg-transparent shadow-none">
      ...
      <div className="flex flex-col md:flex-row h-full relative">
        ...
        <div className="absolute md:static top-0 left-0 w-full md:w-1/2 lg:w-1/3 p-8 z-10 flex flex-col justify-center bg-transparent ">
          <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
            ...
            <div className="w-full flex justify-center">
              ...
              >
 <span style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.7)' }}> {/* Added text shadow to this part */}
 Designing&nbsp;&amp;&nbsp;crafting&nbsp;
                </span>
                ...
                <AnimatedTextCycle
                  ...
                  interval={3000}
                  className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-5 bg-gradient-to-r from-red-400 via-rose-500 to-purple-700 bg-clip-text font-semibold"
                />
              </h2>
            </div>
          </div>
